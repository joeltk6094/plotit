  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          Throughout the {course.duration} program, you'll work on real-world surveying projects, receive personalized
          feedback, and learn from industry experts. By the end of the course, you'll have practical experience and the
          confidence to apply your skills in professional settings.
        </p>
        <p>Join thousands of satisfied students who have mastered surveying with Plotit courses.</p>
      </div>
    </div>
  )
}
