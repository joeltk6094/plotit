...
export default function ChainSurveyPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="transition-opacity duration-500 opacity-100">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: "0.1s", animationFillMode: "both" }}>
                ...
                <div className="flex flex-wrap gap-6 mb-8">
                  ...
                  <div className="flex items-center gap-2 transition-transform duration-300 hover:translate-y-[-2px]">
                    ...
                    <span>4.8/5 (76 reviews)</span>
                  </div>
                </div>

                {/* Enrollment Button */}
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                  <Button className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black px-8 py-6 h-auto text-lg w-full sm:w-auto relative overflow-hidden group transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/20">
                    <span className="relative z-10">Enroll Now for {course.price}</span>
                    <span className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-orange-600 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></span>
                  </Button>
        ...
        {/* Course Navigation */}
        <CourseNavigation activeRoute={routes.courses.chainSurvey.index} />
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              >
                ...
                <Button className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black mb-4 relative overflow-hidden group transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/20">
