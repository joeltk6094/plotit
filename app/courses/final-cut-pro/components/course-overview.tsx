  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          Throughout the {course.duration} program, you'll work on real-world projects, receive personalized feedback,
          and learn from industry experts. By the end of the course, you'll have a portfolio of work and the confidence
          to apply your skills in professional settings.
        </p>
