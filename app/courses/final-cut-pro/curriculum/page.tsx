...
export default function FinalCutProCurriculumPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="transition-opacity duration-500 opacity-100">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-b from-pink-900/20 to-black">
          <div className="container mx-auto px-6 py-16">
            <div className="max-w-3xl mx-auto text-center">
              <Link
                href={courseRoutes.overview}
              ...
              <p className="text-gray-300 text-lg mb-6">
                A comprehensive curriculum designed to take you from beginner to professional in video editing.
              </p>
        ...
        {/* Course Navigation */}
        <CourseNavigation activeRoute={courseRoutes.curriculum} />
